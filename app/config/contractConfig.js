...
import POINT_LIST_FACTORY_ABI from "./abis/PointListFactory.json"
import MISO_LIQUIDITY_LAUNCHER_ABI from "./abis/MISOLiquidityLauncher.json"
...
export const pointListFactory = {
	...
	abi: POINT_LIST_FACTORY_ABI,
}

export const liquidityLauncher = {
	address: {
		1: "", // main
		3: "", // ropsten
		4: "", // rinkeby
	...
	abi: MISO_LIQUIDITY_LAUNCHER_ABI,
}
