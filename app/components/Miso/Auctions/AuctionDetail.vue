          ...
          <card>
            <div class="row">
              <div class="col-sm-12">
                ...
                <span class="d-block h3">{{tokenInfo.address | shortenAddress}}</span>
              </div>
            </div>
          </card>
        </div>
        ...
        <div class="col-sm-6 col-lg-6">
          <card>
            <div class="row">
              ...
              <div class="col-lg-12 mt-2">
                <h5 class="text-uppercase text-muted ls-1 mb-0">Buy remaining now price</h5>
...
export default {
  ...
  computed: {
    ...
    priceAllNow() {
      return `${(this.tokensRemaining * this.clearingPrice) / 10 ** 18} ${this.shortCurrency}`;
    }
  },
  methods: {
    format(timestamp) {
