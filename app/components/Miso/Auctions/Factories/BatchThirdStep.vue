				...
				<div class="col-md-6">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="item">
                                <span class="font-weight-bold text-secondary white_txt fs-2 mb-4">MIN PRICE</span><br>
                                <span class="font-weight-bold text-secondary white_txt fs-2 mb-4">{{ model.minimumCommitmentAmount }} {{ model.paymentCurrency.symbol }}</span>
                            </div>
                            <div class="item">
