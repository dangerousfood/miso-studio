			...
			<div class="row mb-4 bottom-100">
				<div class="col-md-6">
                    <div class="col-12 mb-4">
                        ...
                        <div class="">
                            <span v-if="model.chosenAuctionType === 2" class="font-weight-bold text-secondary white_txt fs-2">Dutch Auction</span>
                            <span v-else-if="model.chosenAuctionType === 1" class="font-weight-bold text-secondary white_txt fs-2">Crowdsale</span>
